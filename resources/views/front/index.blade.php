...
<html lang="es">
  ...
  <head>
    ...
    <!-- Global site tag (gtag.js) - Google Ads: 777146709 -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-777146709"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'AW-777146709');
    </script>
    ...
    <script>
      ...
      fbq('init', '944631409258830');
      fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
                   src="https://www.facebook.com/tr?id=944631409258830&ev=PageView&noscript=1"
      /></noscript>
